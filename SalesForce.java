...
public class SalesForce {
	...
	public static void main(String[] args)  {
		...
		//Enter First Name
		driver.findElement(By.name("UserFirstName")).sendKeys("Iswarya");
		
		//Enter Last Name
		driver.findElement(By.xpath("//input[@name='UserLastName']")).sendKeys("Sekar");

		//Enter work email
		driver.findElement(By.xpath("//input[@name='UserEmail']")).sendKeys("iswarya.sekar@gmail.com");
		...
		//Enter Company
		driver.findElement(By.xpath("//input[@name='CompanyName']")).sendKeys("BNPP");
		...
		//Enter Phone
		driver.findElement(By.xpath("//input[@name='UserPhone']")).sendKeys("9486319376");
