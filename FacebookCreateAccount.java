...
public class FacebookCreateAccount {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@placeholder='First name']")).sendKeys("Iswarya");
		driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Sekar");
		
		//Enter mobile number
		driver.findElement(By.xpath("//input[@name='reg_email__']")).sendKeys("+91 8220925081");
		
		//Enter password
		driver.findElement(By.xpath("//input[@id='password_step_input']")).sendKeys("Password@01");
