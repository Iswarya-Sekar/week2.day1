...
public class LeadCreation {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_lastNameLocal")).sendKeys("Sek");
		driver.findElement(By.id("createLeadForm_personalTitle")).sendKeys("Ms");
		driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("03/11/91");
		driver.findElement(By.id("createLeadForm_generalProfTitle")).sendKeys("Ms.Ishu");
		...
		driver.findElement(By.id("createLeadForm_primaryPhoneAskForName")).sendKeys("Iswarya");
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("iswarya.sekar11cse@gmail.com");
		driver.findElement(By.id("createLeadForm_primaryWebUrl")).sendKeys("http://leaftaps.com/opentaps");
		
		
		//Primary Address
		driver.findElement(By.id("createLeadForm_generalToName")).sendKeys("ISWARYA");
